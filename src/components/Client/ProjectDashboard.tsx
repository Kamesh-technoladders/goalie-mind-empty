          ...
          <div className="glass-card rounded-2xl p-4">
            ...
            <div className="w-full overflow-auto">
              <Table>
                ...
                <tbody>
                  {assignEmployee?.map((project) => (
                    <tr key={project.id} className="hover:bg-white/50 transition-colors border-b">
                      <td className="px-4 py-2">
                        <Checkbox className="rounded-md" />
                      </td>
                      <td className="px-4 py-2 font-medium cursor-pointer hover:text-primary">
                        {project.hr_employees ? `${project.hr_employees.first_name} ${project.hr_employees.last_name}` : "N/A"}
                      </td>
